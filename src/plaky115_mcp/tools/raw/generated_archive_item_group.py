...
def build_tool(client: AsyncPlakyClient) -> ToolSpec:
    ...
    return ToolSpec(
        ...
        description="Archive an item group; it performs the requested change. Requires space ID, board ID, item group ID and write and destructive scope. This performs a live write with no dry-run; if a failure is ambiguous, inspect the receipt and do not repeat blindly.",
