...
from plaky115.models.generated import ItemGroupCreateRequest
...
def build_tool(client: AsyncPlakyClient) -> ToolSpec:
    ...
    return ToolSpec(
        ...
        description="Create an item group; it performs the requested change. Requires space ID, board ID and write scope. This performs a live write with no dry-run; if a failure is ambiguous, inspect the receipt and do not repeat blindly.",
