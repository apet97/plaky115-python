...
def build_tool(client: AsyncPlakyClient) -> ToolSpec:
    ...
    return ToolSpec(
        ...
        description="Update item comment; it performs the requested change. Requires space ID, board ID, item ID, item comment ID and write scope. This performs a live write with no dry-run; if a failure is ambiguous, inspect the receipt and do not repeat blindly.",
