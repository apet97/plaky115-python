...
def build_tool(client: AsyncPlakyClient) -> ToolSpec:
    ...
    return ToolSpec(
        ...
        title="Get item file",
        description="Retrieve an item file; it returns the requested result. Requires space ID, board ID, item ID, item file ID and read scope. This operation is read-only.",
